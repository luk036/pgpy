...
# -*- coding: utf-8 -*-
"""
Setup script for pgpy

You can install pgpy with
...
if sys.version_info[:2] < (2, 7):
    print("pgpy requires Python 2.7 or later (%d.%d detected)." %
          sys.version_info[:2])
    sys.exit(-1)

# Write the version information.
sys.path.insert(0, 'pgpy')
import release
...
# docdirbase = 'share/doc/pgpy-%s' % version
